r"""
This file is from FastChat: https://github.com/lm-sys/FastChat/blob/main/fastchat/model/compression.py
"""
import os
import gc
import glob
...
def load_compress_model(model_path, device, torch_dtype, use_fast, revision="main", use_safetensors=False):
    ...
    for filename in tqdm(files):
        if use_safetensors:
            tmp_state_dict = safetensors.torch.load_file(filename)
        else:
